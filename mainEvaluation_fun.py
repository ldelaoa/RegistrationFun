...
def mainEval(registered_dict,intermediate_dict,pxID,save_CSVs):
    ...
    ldctLung_v2_t,petLung_v2_t = OnlyRead_registered(registered_dict, True)#True is Lung Crop
    ...
    ldctClinic_v2_t,petClinic_v2_t = OnlyRead_registered(registered_dict, False)#False is Clinic
