...
def mainRegister(save_register,intermediate_dict,pxID,save_CSVs):
    ...
    registCT1_LM, registPET1_LM,  _, _, _, _, _, _, _ = Register_fun(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    ...
    print("Regist 1 Done")
    registCT2_LM, registPET2_LM,  _, _, _, _, _, _, _ = Register_fun_v2(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    ...
    print("Regist 2 Done")
    registCT3_LM, registPET3_LM, _, _, _, _, _, _, _ = Register_fun_v3(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    ...
    registCT1_LM, registPET1_LM,  _, _, _, _, _, _, _ = Register_fun_v4(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT1_LM, filename=save_register + "LDCT_LungCrop_Register_v4.nii.gz")
    save_nifti_without_header(registPET1_LM, filename=save_register + "PET_LungCrop_Register_v4.nii.gz")
    print("Regist 4 Done")
    registCT2_LM, registPET2_LM,  _, _, _, _, _, _, _ = Register_fun_v5(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT2_LM, filename=save_register + "LDCT_LungCrop_Register_v5.nii.gz")
    save_nifti_without_header(registPET2_LM, filename=save_register + "PET_LungCrop_Register_v5.nii.gz")
    print("Regist 5 Done")
    registCT3_LM, registPET3_LM, _, _, _, _, _, _, _ = Register_fun_v6(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT3_LM, filename=save_register + "LDCT_LungCrop_Register_v6.nii.gz")
    save_nifti_without_header(registPET3_LM, filename=save_register + "PET_LungCrop_Register_v6.nii.gz")
    print("Regist 6 Done")
    
    registCT1_LM, registPET1_LM,  _, _, _, _, _, _, _ = Register_fun_v7(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT1_LM, filename=save_register + "LDCT_LungCrop_Register_v7.nii.gz")
    save_nifti_without_header(registPET1_LM, filename=save_register + "PET_LungCrop_Register_v7.nii.gz")
    print("Regist 7 Done")
    registCT2_LM, registPET2_LM,  _, _, _, _, _, _, _ = Register_fun_v8(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT2_LM, filename=save_register + "LDCT_LungCrop_Register_v8.nii.gz")
    save_nifti_without_header(registPET2_LM, filename=save_register + "PET_LungCrop_Register_v8.nii.gz")
    print("Regist 8 Done")
    registCT3_LM, registPET3_LM, _, _, _, _, _, _, _ = Register_fun_v9(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT3_LM, filename=save_register + "LDCT_LungCrop_Register_v9.nii.gz")
    save_nifti_without_header(registPET3_LM, filename=save_register + "PET_LungCrop_Register_v9.nii.gz")
    print("Regist 9 Done")

    registCT1_LM, registPET1_LM,  _, _, _, _, _, _, _ = Register_fun_v10(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT1_LM, filename=save_register + "LDCT_LungCrop_Register_v10.nii.gz")
    save_nifti_without_header(registPET1_LM, filename=save_register + "PET_LungCrop_Register_v10.nii.gz")
    print("Regist 10 Done")
    registCT2_LM, registPET2_LM,  _, _, _, _, _, _, _ = Register_fun_v11(PlanCT_LungCrop_tensor[0], LDCT_LungCrop_tensor[0], PET_LungCrop_tensor[0], pxID)
    save_nifti_without_header(registCT2_LM, filename=save_register + "LDCT_LungCrop_Register_v11.nii.gz")
    save_nifti_without_header(registPET2_LM, filename=save_register + "PET_LungCrop_Register_v11.nii.gz")
